...
import { NewAttachmentsData } from "../../app/attachments/_utils/getNewAttachmentsData";
...
import { GetNewAttachmentsFilesButton } from "../../app/attachments/_components/_buttons/GetNewAttachmentsMetaButtons";
...
export const EmailsMetaPreviewTable = ({ meta }: { meta: NewAttachmentsData }) => {
  ...
  return (
    <div className={`flex p-6 flex-col justify-between  h-full min-h-[90%] overflow-auto `}>
      <div>
        {meta.map((data, idx) => (
